...
from ...models.decoded_model import DecodedCall, TransactionMetadata
from ethtx_ce.semantics.standards.erc20 import ERC20_FUNCTIONS, ERC20_TRANSFORMATIONS
from ethtx_ce.semantics.standards.erc721 import ERC721_FUNCTIONS, ERC721_TRANSFORMATIONS
        ...
        with RecursionLimit(RECURSION_LIMIT):
            if call.sub_calls:
                for sub_call in call.sub_calls:
                    self.decode(sub_call, tx_metadata)
